...
void asus_set_battery_version(void)
{
    ...
    char sw_driver_version[15] = "80.30.96.98";
    ...
    strncpy( profile_version, "0003", sizeof(profile_version));
...
void asus_check_rconn(void)
{
	...
	if(g_fgChip->dt.rconn_mohms == 0)
	{
		pr_err("g_fgChip->dt.rconn_mohms is 0 !\n");
		flag = 0;
	}
